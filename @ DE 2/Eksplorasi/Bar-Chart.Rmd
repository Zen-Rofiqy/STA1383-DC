...
export.chart <- "C:/Users/Fathan/Downloads/File"
```

```{r}
data <- import("https://raw.githubusercontent.com/Zen-Rofiqy/STA1383-DC/main/%40%20DE%202/Eksplorasi/Data.csv") %>% as.data.frame()
head(data, n=10)
```
